...
class PMLauncherContentImport implements  PMLauncherImporter {
...
class WP_Import_PM extends WP_Importer {
...
function aviators_launcher_importer_init() {
     ...
     */
    $GLOBALS['wp_import_PM'] = new WP_Import_PM();
    register_importer( 'wordpress', 'WordPress', __('Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file.', 'pm-importer'), array( $GLOBALS['wp_import_PM'], 'dispatch' ) );
}
