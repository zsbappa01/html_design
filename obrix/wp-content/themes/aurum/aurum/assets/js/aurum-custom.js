...
;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
		...
		if($.isFunction($.fn.owlCarousel) && $( '.item-details-single .product-images-gallery .shop-item' ).length == 1 )
		{
		...
		// Image Magnifier
		var $magnifier = $(".shop-item .product-images.magnify-active");
		...
		$( 'body' ).on( 'added_to_wishlist', function() {
			for ( var i in addedToWishtlistIds ) {
				...
				$( '.products .shop-item.post-' + id + ' .yith-add-to-wishlist' ).removeClass( 'is-loading' );
