	...
	$(document).ready(function()
	{
		...
		$("#contact-form").on('submit', function(ev)
		{
			...
			else // Send the message
			{
				...
				$.post(ajaxurl, {action: 'lab_req_contact_token', form_data: {name: name.val(), subject: subject.val(), email: email.val(), phone: phone.val(), message: message.val()}}, function(resp)
				{
					var hn = resp.split('_'),
						ver = {
							name: hn[0],
