...
$of_options[] = array( 	"desc" 		=> "Left text on top menu bar",
...
$of_options[] = array( 	"desc" 		=> "Right text on top menu bar",
...
$of_options[] = array( 	"desc" 		=> "Show wishlist icon in item thumbnails" . ( ! defined( 'YITH_WCWL_URL' ) ? ' <mark style="background-color: #eaeaea; padding: 2px 4px; color: #999999; border-radius: 2px;">YITH Wishlist plugin is required</mark>' : '' ),
