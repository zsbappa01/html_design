...
function lab_1cl_demo_installer_get_packs()
{
	return array(
		array(
			...
			'file'           => array( 
									'demo-content/fashion-store/wxr/posts.xml',
									'demo-content/fashion-store/wxr/pages.xml',
									'demo-content/fashion-store/wxr/navs.xml',
									'demo-content/fashion-store/wxr/testimonials.xml',
									'demo-content/fashion-store/wxr/products.xml',
									'demo-content/fashion-store/wxr/variations.xml',
									'demo-content/fashion-store/wxr/media.xml',
								),
