...
function laborator_init()
{
	...
	wp_register_script('aurum-custom', THEMEASSETS . 'js/aurum-custom.min.js', null, $theme_version, true);
	wp_register_script('aurum-contact', THEMEASSETS . 'js/aurum-contact.min.js', null, $theme_version, true);
...
<div class="wrap">
	...
	<p>
		<a href="//documentation.laborator.co/item/aurum/?theme-inline=true" target="_blank" class="button button-primary" id="lab_read_docs">Read Documentation</a>
	</p>
