...
<div class="header-links">
	...
	<ul class="header-widgets">
		...
		?>
		<li>
			<a class="cart-counter<?php echo $cart_items_count ? ' has-notifications' : ''; echo $shop_cart_counter_ajax ? ' cart-counter-ajax' : ''; echo $shop_cart_show_on_hover ? ' hover-activated' : ''; echo apply_filters( 'aurum_mini_cart_direct_link', false ) ? ' direct-link' : ''; ?>" href="<?php echo wc_get_cart_url(); ?>">
