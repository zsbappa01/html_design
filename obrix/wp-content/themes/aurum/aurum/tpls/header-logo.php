...
<div class="logo<?php echo ! $use_image_logo ? ' text-logo' : ''; ?>">
	...
	<?php if($use_image_logo): ?>
		...
		<img src="<?php echo str_replace( array( 'http:', 'https:' ), '', $logo_url ); ?>" class="logo-dimensions normal-logo" id="site-logo" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" width="<?php echo $max_width; ?>"<?php if(isset($logo_height)): ?> height="<?php echo $logo_height; ?>"<?php endif; ?> />

		<?php if(has_transparent_header() && $custom_logo_image_light): ?>
		<img src="<?php echo str_replace( array( 'http:', 'https:' ), '', $custom_logo_image_light ); ?>" class="logo-dimensions light-logo" id="site-logo-light" alt="<?php echo esc_attr(get_bloginfo('name')); ?>-light" width="<?php echo $max_width; ?>"<?php if(isset($logo_height)): ?> height="<?php echo $logo_height; ?>"<?php endif; ?> />
		<?php endif; ?>
	<?php else: ?>
