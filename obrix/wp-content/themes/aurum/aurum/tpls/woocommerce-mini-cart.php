	...
	<div class="cart-bottom">
		<div class="row">
			<div class="col-sm-6 omega">
				<a href="<?php echo wc_get_cart_url(); ?>" class="button btn btn-default btn-large btn-block wc-forward"><?php _e( 'View Cart', 'aurum' ); ?></a>
			</div>
			<div class="col-sm-6 alpha">
				<a href="<?php echo wc_get_checkout_url(); ?>" class="button btn btn-primary btn-large btn-block checkout wc-forward"><?php _e( 'Checkout', 'aurum' ); ?></a>
			</div>
		</div>
