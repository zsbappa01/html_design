...
# Catalog Image Size
$shop_catalog_image_size            = strtolower( get_data( 'shop_catalog_image_size' ) );
$shop_catalog_image_size_default    = array(290, 370);
$shop_catalog_image_crop            = true;

if( preg_match( "/^[0-9]+x[0-9]+(x0)?$/i", $shop_catalog_image_size, $matches ) ) {
...
$shop_single_image_size            = strtolower( get_data( 'shop_single_image_size' ) );
$shop_single_image_size_default    = array(555, 710);
$shop_single_image_crop            = true;

if( preg_match( "/^[0-9]+x[0-9]+(x0)?$/i", $shop_single_image_size, $matches ) ) {
