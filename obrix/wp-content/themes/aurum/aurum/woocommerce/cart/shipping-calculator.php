...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<p><a href="#" class="shipping-calculator-button btn btn-gray btn-block"><?php _e( 'Calculate shipping', 'woocommerce' ); ?></a></p>
		...
		<p class="form-row form-row-wide" id="calc_shipping_state_field">
			<?php
				...
				// Dropdown Input
					...
					?><span>
						<select name="calc_shipping_state" class="state_select" id="calc_shipping_state" placeholder="<?php esc_attr_e( 'State / County', 'woocommerce' ); ?>" class="form-control">
